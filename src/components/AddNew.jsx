...
const AddNew = () => {
  return (
    <section className={`w-full ${styles.paddingX} ${styles.paddingY} font-inter sticky bottom-0 bg-white`}>
      <div className="w-full h-14 flex justify-between items-center mb-5 px-5 border-[1px] border-primary rounded-[10px]" >
        <input type="text" className="h-full focus:outline-none" />
